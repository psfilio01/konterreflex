...
insert into public.scenarios (id,title,category,status,source,created_by)
values ('90000000-0000-4000-8000-000000000001','KI-Entwurf','Test','active','generated','99999999-9999-4999-8999-999999999999');
...
select throws_ok(
  $$ insert into public.scenarios (title,category,status,source) values ('Unerlaubt','Test','draft','manual') $$,
  '42501',
  null,
